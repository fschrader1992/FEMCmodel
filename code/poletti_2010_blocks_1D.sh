...
for j in 0
  do
    ...
    do
      ...
      #create images, FEM=0
      python3 image_creation_poletti_2010_1D_blocks.py ${i} 0
    ...
    python3 ms_input.py poletti2010/blocks/${j}/dot dot_${j} 1000 &
    python3 ms_input.py poletti2010/blocks/${j}/border border_${j} 1000 &
    python3 ms_input.py poletti2010/blocks/$((j+1))/dot dot_$((j+1)) 1000 &
    python3 ms_input.py poletti2010/blocks/$((j+1))/border border_$((j+1)) 1000
    ...
    python3 ms_input.py poletti2010/blocks/${j}/dot_m dot_m_${j} 1000 &
    python3 ms_input.py poletti2010/blocks/${j}/border_m border_m_${j} 1000 &
    python3 ms_input.py poletti2010/blocks/$((j+1))/dot_m dot_m_$((j+1)) 1000 &
    python3 ms_input.py poletti2010/blocks/$((j+1))/border_m border_m_$((j+1)) 1000
    ...
    do
      ...
      python3 ms_network_no_m.py poletti2010/blocks/${i}/dot dot_${i} 32. 16. 1000 dot ${i}
      python3 ms_network_no_m.py poletti2010/blocks/${i}/dot_m dot_m_${i} 62. 16. 1000 dot_m ${i}
      python3 ms_network_no_m.py poletti2010/blocks/${i}/border border_${i} 32. 16. 1000 border ${i}
      python3 ms_network_no_m.py poletti2010/blocks/${i}/border_m border_m_${i} 62. 16. 1000 border_m ${i}
...
for j in {1..10..2}
  do
    ...
    do
      ...
      #create images, FEM=1
      python3 image_creation_poletti_2010_1D_blocks.py ${i} 1
